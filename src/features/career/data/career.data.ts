...
- 솔라피 API 연동`,
      `[공유기 관리 어드민 페이지] (Vue)
- 프로젝트의 공용 컴포넌트를 구현했습니다.
- Chart를 포함한 대쉬보드, 페이지 전반의 퍼블리싱을 진행했습니다.
- 스웨거(Swagger) 문서를 기반으로 Vue Query를 활용하여 API 연동 및 데이터 처리 로직을 구현했습니다.
      `,
      `[Z-one 체육 대학 합격 예측] (Next)
- 공통 컴포넌트를 제작하여 코드의 재사용성과 유지보수성을 향상시켰습니다.
- 어드민 페이지와 정시/수시 대학 찾기 페이지의 퍼블리싱 및 API 연동을 수행했습니다.
- 대학 찾기 및 대학 관리 필터 기능을 구축했습니다.
- 오픈 전, 전반적인 수정을 하였습니다.
      `,
      `[Xpla] (Next)
